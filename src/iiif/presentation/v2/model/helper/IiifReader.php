<?php
namespace iiif\presentation\v2\model\helper;
...
class IiifReader {
     ...
     * @param array $thumbnailServiceProfiles
     *            Assaociative array for caching purporses. If the thumbnail provides a service with a profile url,
     *            this url might get requested. Using this array reduces the number of nescessary requests.
     * @param mixed $classWithStaticGetUrlMethod
     *            Written for TYPO3's GeneralUtility
     * @return NULL|string
     */
